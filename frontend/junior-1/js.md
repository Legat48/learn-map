...
Вар отличается от лет и конст тем, что оно, вне зависимости от места объявления поднимается на самый верх области видимости и фактически объявляется там, его значение видно в начале области видимости. Значение let и const не видно до места их объявления
